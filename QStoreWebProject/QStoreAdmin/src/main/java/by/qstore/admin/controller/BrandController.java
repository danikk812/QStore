...
public class BrandController {
    ...
    public ModelAndView saveBrand(@ModelAttribute("brandForm") Brand brand, RedirectAttributes redirectAttributes,
    ...
    public ModelAndView editBrand(@PathVariable(name = "id") long id, RedirectAttributes redirectAttributes,
    ...
    public ModelAndView deleteBrand(@PathVariable(name = "id") long id, RedirectAttributes redirectAttributes,
                                   ModelAndView modelAndView) {
        try {
